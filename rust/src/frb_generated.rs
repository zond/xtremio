...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = 1240587314;
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        28 => wire__crate__api__server__server_drive_open_impl(port, ptr, rust_vec_len, data_len),
        ...
        33 => wire__crate__api__server__server_note_player_opened_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        34 => wire__crate__api__server__server_note_player_stalled_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ...
        36 => wire__crate__api__server__server_settings_impl(port, ptr, rust_vec_len, data_len),
        37 => wire__crate__api__server__server_start_impl(port, ptr, rust_vec_len, data_len),
        38 => wire__crate__api__server__server_stop_impl(port, ptr, rust_vec_len, data_len),
        39 => {
        ...
        43 => wire__crate__api__subtitles__subtitles_match_impl(port, ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
