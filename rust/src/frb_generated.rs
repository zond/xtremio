...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = 445434324;
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        21 => wire__crate__api__server__server_settings_impl(port, ptr, rust_vec_len, data_len),
        22 => wire__crate__api__server__server_start_impl(port, ptr, rust_vec_len, data_len),
        23 => wire__crate__api__server__server_stop_impl(port, ptr, rust_vec_len, data_len),
        24 => {
